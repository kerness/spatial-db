...
-- 2: convert 'obiekt4' to polygon - so the line endings in 'obiekt4' must be closed!
...
-- convert to closed linestring

-- st_addpoint - adds a point to a LineString before point
